...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_12641: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_12702: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15847: (a: number, b: number, c: number) => void;
